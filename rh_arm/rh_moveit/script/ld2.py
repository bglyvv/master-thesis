...
class RotateAndDetect:
    ...
    def lidar_callback(self, data):
        ...
        try:
            (trans, rot) = self.tf_listener.lookupTransform('/world', '/base_lidar_front', rospy.Time(0))
    ...
    def move_to_object(self):
        ...
        target_pose.position.z = current_pose.position.z - 0.1  # Adjust the height to grasp the object
        ...
        self.control_gripper([0.04, 0.04])  # Example positions to close the gripper
        rospy.sleep(2)

        rospy.loginfo("Moving the object to the place position.")
        self.move_to_target(0.5, 0.5, 0.1)  # Example target position
